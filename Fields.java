public class Fields {
        ...
        public Fields() {
                ...
                gameBoard = new Board[13];

                gameBoard[0] = new Board("The Void", 0, "Oh no, you've rolled zero! Your turn is now skipped!");

                gameBoard[1] = new Board("Theif's den", 100,
                                "You are the one and only theif! You steal 100 points from the other player.");

                gameBoard[2] = new Board("The Tower", 250,
                                "You walk up to a huge tower, and climb the stairs - on the top of the stairs you find 250 gold!");

                gameBoard[3] = new Board("The Crater", -100,
                ...
                gameBoard[4] = new Board("Palace Gates", 100,
                ...
                gameBoard[5] = new Board("Cold Desert", -20,
                ...
                gameBoard[6] = new Board("Walled City", 180,
                ...
                gameBoard[7] = new Board("The Monastrey", 0,
                                "A monastery is a place for salvation and rest - here is no gold, only peace.");

                gameBoard[8] = new Board("Black Cave", -70,
                ...
                gameBoard[9] = new Board("Huts in the Mountains", 60,
                ...
                gameBoard[10] = new Board("The Werewall", -80,
                ...
                gameBoard[11] = new Board("The Pit", -50,
                ...
                gameBoard[12] = new Board("The Goldmine", 650,
